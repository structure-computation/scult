...
PRG_test_read_data_v2_cpu = SC_test_read_data_v2_cpu_$(DIM).exe
...
metil_comp_test_read_data_v2_cpu :
	$(LOC_MC)  -o  $(PRG_test_read_data_v2_cpu) -DDIM=$(DIM) -DGPU  -DTYPE=double -DTYPEREEL=double -DLDL -DWITH_CHOLMOD -DWITH_UMFPACK $(DIR_SOURCES_LMT) $(DIR_SOURCES_COMPUTE) $(CFLAGS) $(LIBS) $(OPT)  src/test_read_DataUser_v2.cpp 8
