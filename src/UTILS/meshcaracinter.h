...
public:
    ...
    struct NodalStaticData {
        ...
        void dm_data_set_field( const Sc2String field_name, Tpos value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Vec<Tpos,1> &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Vec<Tpos,2> &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Vec<Tpos,3> &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Vec<Tpos,4> &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Vec<Tpos,5> &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Vec<Tpos,6> &value ) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Mat<double, LMT::Gen<0, 0>, LMT::Dense<LMT::Col> > &value) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Mat<double, LMT::Gen<1, 1>, LMT::Dense<LMT::Col> > &value) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Mat<double, LMT::Gen<2, 2>, LMT::Dense<LMT::Col> > &value) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Mat<double, LMT::Gen<3, 3>, LMT::Dense<LMT::Col> > &value) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Mat<double, LMT::Gen<4, 4>, LMT::Dense<LMT::Col> > &value) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Mat<double, LMT::Gen<5, 5>, LMT::Dense<LMT::Col> > &value) { assert(0); /*TODO*/ }
        void dm_data_set_field( const Sc2String field_name, const Mat<double, LMT::Gen<6, 6>, LMT::Dense<LMT::Col> > &value) { assert(0); /*TODO*/ }
        template<class __G__> __G__ dm_data_get_field( const Sc2String field_name, StructForType<__G__> ) const { assert( 0 /*TODO*/ ); return __G__( 0.0 );  }
    };
